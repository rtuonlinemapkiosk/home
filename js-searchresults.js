...
} else if (from.trim().toLowerCase() === "medical & dental clinic building" && to.trim().toLowerCase() === "itc building") {
    return {
        steps: [
...
} else if (from.trim().toLowerCase() === "medical & dental clinic building" && to.trim().toLowerCase() === "wellness building") {
    return {
        steps: [
...
} else if (from.trim().toLowerCase() === "medical & dental clinic building" && to.trim().toLowerCase() === "r&d building") {
    return {
        steps: [
...
} else if (from.trim().toLowerCase() === "medical & dental clinic building" && to.trim().toLowerCase() === "old building") {
    return {
       steps: [
        "Leave  Medical & Dental Clinic Building and Turn left",
        "Walk straight passed OLD Building (South Wing)",
...
} else if (from.trim().toLowerCase() === "medical & dental clinic building" && to.trim().toLowerCase() === "snagah building") {
    return {
        steps: [
            "Leave  Medical & Dental Clinic Building and Turn left",
            "Walk straight passed OLD Building (South Wing)",
...
} else if (from.trim().toLowerCase() === "medical & dental clinic building" && to.trim().toLowerCase() === "dormitory building") {
    return {
        steps: [
...
} else if (from.trim().toLowerCase() === "medical & dental clinic building" && to.trim().toLowerCase() === "engineering laboratory building") {
    return {
        steps: [
            "Leave Medical & dental building and Turn right",
            "Walk straight passed ITC Building",
...
} else if (from.trim().toLowerCase() === "medical & dental clinic building" && to.trim().toLowerCase() === "mab building") {
    return {
        steps: [
...
} else if (from.trim().toLowerCase() === "medical & dental clinic building" && to.trim().toLowerCase() === "gate-1") {
    return {
        steps: [
            "Leave Medical & dental building and walk straight passed University Quadrangle",
            "Turn right at Old Building",
...
} else if (from.trim().toLowerCase() === "medical & dental clinic building" && to.trim().toLowerCase() === "gate-2") {
    return {
        steps: [
            "Leave Medical & dental building and walk straight passed University Quadrangle",
            "Turn right at Old Building",
...
} else if (from.trim().toLowerCase() === "medical & dental clinic building" && to.trim().toLowerCase() === "gate-3") {
    return {
        steps: [
            "Leave Medical & dental building and walk straight passed University Quadrangle",
            "Turn right at Old Building",
...
} else if (from.trim().toLowerCase() === "medical & dental clinic building" && to.trim().toLowerCase() === "gate-4") {
    return {
        steps: [
            "Leave Medical & dental building and walk straight passed University Quadrangle",
            "Turn right",
...
} else if (from.trim().toLowerCase() === "medical & dental clinic building" && to.trim().toLowerCase() === "gate-5") {
    return {
        steps: [
...
} else if (from.trim().toLowerCase() === "medical & dental clinic building" && to.trim().toLowerCase() === "university gymnasium") {
    return {
        steps: [
            "Leave Medical & dental building and walk straight passed University Quadrangle",
            "Turn right at Old Building",
...
} else if (from.trim().toLowerCase() === "medical & dental clinic building" && to.trim().toLowerCase() === "university quadrangle") {
    return {
        steps: [
...
} else if (from.trim().toLowerCase() === "medical & dental clinic building" && to.trim().toLowerCase() === "old building (south wing)") {
    return {
        steps: [
            "Leave Medical & dental building and Turn left",
            "Walk straight",
...
} else if (from.trim().toLowerCase() === "medical & dental clinic building" && to.trim().toLowerCase() === "itb building") {
    return {
        steps: [
            "Leave Medical & dental building and Turn right",
            "Walk straight",
